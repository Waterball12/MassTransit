        ...
        FutureTestFixture
    {
            ...
            IConsumer<SubmitOrder>
        {
            ...
            public async Task Consume(ConsumeContext<SubmitOrder> context)
            {
                ...
                Task<FryCompleted[]> fries = Task.WhenAll(context.Message.Fries?.Select(x => _fryExecutor.Execute(planContext.Push<Fry>(x)))
